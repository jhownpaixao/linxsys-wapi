...
final class ConnectionException extends Exception
{
    ...
    public function __construct(string $host, string $message = '', int $requestCodeStatus = 500, Logger $logger = null, \Throwable $previous = null)
    {
        $message = "Unable to connect to host '$host'. Error: $message";
        if ($logger) {
